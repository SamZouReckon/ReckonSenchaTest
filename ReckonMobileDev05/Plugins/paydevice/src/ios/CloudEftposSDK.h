...
#define CloudEftposSDK_version 1.1.6
 ...
 *            For example: "-123.456789,-38.485868"
...
/* Custom Start Transaction allows you to use your own transaction interface */

/*!
 *  @block customDisplayBlock
 *
 *  @param msg The display message. This should be displayed to the user.
 *
 *  @discussion This block is called every time the PINpad sends a display
 *  message to the POS. You should display all of these messages. Messages
 *  should not require user interaction or confirmation (don't use alerts!)
 */
 ...
 *  customisation of the transaction UI.
 */
-(void) startTransaction:(TransactionRequest *)transactionRequest
 ...
 *  @param password The password of the authenticating user
 *
 *  @return bool True if the password was correct.
 *
 *  @discussion Verifies a users password. Will only work if the user has
 *  previously (and successfully) authorised against the system.
 */
