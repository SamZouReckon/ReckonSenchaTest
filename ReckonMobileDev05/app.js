...
Ext.application({    
    ...
    controllers: ['MainC', 'TestScreenC', 'CoreSettingsC', 'AppStopC', 'ModulesC', 'ModuleSignupC', 'AboutC', 'ContactsC', 'ContactDetailC', 'MyPreferencesC', 'EnterPinC', 'EnterUsernameC', 'CreatePinC', 'CashBooksC', 'CustomersC', 'BudgetLineItemsC', 'BillsC', 'ItemsC', 'DashboardC', 'ForgotPasswordC', 'CustomerInvoicesC', 'InvoicesC', 'InvoiceDetailC', 'InvoiceLineItemC', 'InvoiceItemSelectC', 'InvoiceTimeSelectC', 'InvoiceExpenseSelectC', 'InvoiceTimeSelectDetailC', 'InvoiceBalanceBreakdownC', 'InvoiceActionsC', 'HistoryC', 'CustomDiscountC', 'TimeSheetsC', 'TimeSheetDetailC', 'ExpenseDetailC', 'ExpensesC', 'ProjectsC', 'SuppliersC', 'EmailInvoiceC', 'AddNoteC', 'ItemsAmountsC', 'ItemDetailC', 'CreateItemC', 'AcceptPaymentC', 'ReceiptPhotoPreviewC', 'PayAmountInputC', 'PayTransTypeSelectC', 'PayAmountDetailsC', 'PaySalesHistoryC','PayRecvCashC', 'PayRecvChequeC', 'PayRecvManualCardC', 'PaySendReceiptC', 'PayTransTerminalC', 'PayTransDetailsC', 'PayTransRefundC','PayPreferencesC', 'PayAmountInputBackC', 'PayAmountInputNavC', 'PayTransCardSignC', 'PinAuthenticationC', 'AccountsC'],
