Ext.define('RM.component.DropdownButton', {
	...
	initialize: function() {
        ...
        this.setText(options[0].text + '<span> <img src="resources/images/icons/rm-dropdown.png" style="margin-left: 5px; margin-bottom: 2px;"></span>');        
			...
			for (var i=0;i<options.length;i++)
				{ 
						...
						if(itemId==option.value) {
						    ...
						    this.setText(option.text + '<span> <img src="resources/images/icons/rm-dropdown.png" style="margin-left: 5px; margin-bottom: 2px;"></span>');
							break;
						}
				}
		}
