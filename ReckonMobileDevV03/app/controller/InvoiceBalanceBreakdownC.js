    ...
    onShow: function () {
        ...
        this.getBreakdownCont().setHtml(Ext.util.Format.format(
            '<table width="90%" class="rm-tablelayout">' +        
                ...
                '</tr>' + 
             '</table>', 
            this.formatNumber(data.Subtotal), 
            this.formatNumber(data.DiscountTotal), 
            this.formatNumber(data.AmountExTax), 
            this.formatNumber(data.Tax), 
            this.formatNumber(data.Amount), 
            this.formatNumber(data.Paid), 
            this.formatNumber(data.BalanceDue))
        );
    },
