 ...
 *
 */
Ext.define('Ext.ux.touchcalendar.TouchCalendarView', {
    ...
    applyViewMode: function(viewMode){
        ...
        var viewModeFns = Ext.ux.touchcalendar.TouchCalendarView[viewMode.toUpperCase()];
    ...
    statics: {
        ...
        MONTH: {
            ...
            getStartDate: function(date){
                return Ext.bind(Ext.ux.touchcalendar.TouchCalendarView.WEEK.getStartDate, this)(new Date(date.getFullYear(), date.getMonth(), 1));
            },
